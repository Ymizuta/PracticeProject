...
public class MapCreater : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        //ラベルはマウスクリックのイベントを取得しない、つまりユーザーインタラクションを持たず、
        //ノーマルスタイルでレンダリングされます。ユーザー入力を視覚的に応答するコントロールを作成する場合は、
        //Box を使用してください。
